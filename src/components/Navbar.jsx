        ...
        >
            <div className="flex items-center justify-end md:justify-center lg:justify-end px-6 py-4">
                    ...
                    {links.map(({ id, name, to }) => (
                        <li key={id}>
                            <button
                                ...
                                className="cursor-pointer text-blue-500 hover:text-blue-500 transition focus:outline-none focus:ring-2 focus:ring-orange-500 rounded"
                            >
                                {name}
                            </button>
                        </li>
                ...
                <button
                    ...
                    className="md:hidden cursor-pointer text-blue-500 text-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 rounded"
                >
                ...
                >
                    {links.map(({ id, name, to }) => (
                        <li key={id}>
                            <button
                                onClick={() => handleScroll(to)}
                                className="cursor-pointer text-blue-500 hover:text-blue-500 text-lg focus:outline-none focus:ring-2 focus:ring-orange-500 rounded"
                            >
                                {name}
                            </button>
                        </li>
