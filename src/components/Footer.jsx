            ...
            <div className="container mx-auto text-center">
                <div className="flex justify-between mb-5">
                    <div className="flex items-baseline space-x-3  mx-20">
                        ...
                        <h1 className="text-xl  font-bold">Mobivo</h1>
                    </div>
                ...
                <div className="flex justify-around text-left  flex-col-2 md:flex-row mt-10">
                    ...
                    <div>
                        ...
                        <ul>
                            <li className="my-2 cursor-pointer">A technology$ innovation Design</li>
                            <li className="my-2 cursor-pointer">Accessories Design</li>
                            <li className="my-2 cursor-pointer">business management</li>
                ...
                <p className="mt-8 text-sm">&copy; 2025 Mobivo - All rights reserved.</p>
